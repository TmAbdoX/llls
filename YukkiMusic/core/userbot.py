...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("M_ii_x_1")
                await self.one.join_chat("me_xec_o")
                await self.one.join_chat("UXXHT")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("M_ii_x_1")
                await self.two.join_chat("me_xec_o")
                await self.two.join_chat("UXXHT")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("M_ii_x_1")
                await self.three.join_chat("me_xec_o")
                await self.three.join_chat("UXXHT")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("M_ii_x_1")
                await self.five.join_chat("me_xec_o")
                await self.five.join_chat("UXXHT")
            except:
                pass
            assistants.append(5)
            try:
